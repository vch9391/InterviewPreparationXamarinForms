...
using InterviewPreparationXamarinForms.CustomRenderer;
using InterviewPreparationXamarinForms.Droid.CustomRenderer;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(StandardEntry), typeof(StandardEntryRenderer))]
namespace InterviewPreparationXamarinForms.Droid.CustomRenderer
{
